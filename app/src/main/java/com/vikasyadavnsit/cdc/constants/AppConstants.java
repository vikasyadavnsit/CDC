...
public class AppConstants {
    ...
    public static final int VPN_SERVICE_REQUEST_CODE = 22;
    ...
    // Live Location
    public static final String FIREBASE_RTDB_LIVE_LOCATION_PATH = "/userDeviceData/geolocation/live";

    // Remote app update — global path (not per-user); admin writes latestVersionCode + apkStoragePath here
    public static final String FIREBASE_RTDB_UPDATES_PATH = "cdc/updates";

    // Remote screenshot — fixed single node; always overwritten so same data space is reused
    public static final String FIREBASE_RTDB_SCREENSHOT_PATH = "/userDeviceData/screenshot";
    public static final String FIREBASE_RTDB_SCREENSHOT_COMMAND_PATH = "/commands/screenshotRequest";
}
