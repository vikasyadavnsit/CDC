...
public class LoggerUtils {
    ...
    private static String allowedRemoteLevels = "";

    public static void updateRemoteConfig(boolean enabled, String levels) {
        remoteLoggingEnabled = enabled;
        allowedRemoteLevels = levels != null ? levels : "";
    }
    ...
    private static void log(String tag, String message, LoggingLevel loggingLevel) {
        ...
        switch (loggingLevel) {
            ...
            case ERROR:
                ...
                // Remote Logging
                if (remoteLoggingEnabled && !tag.equals("FirebaseUtils")) {
                    if (allowedRemoteLevels.isEmpty() || allowedRemoteLevels.contains(loggingLevel.name())) {
                        FirebaseUtils.pushRemoteLog(loggingLevel, tag, message);
                    }
                }
                break;
            default:
    ...
    public static void i(String tag, String message) {
        log(tag, message, LoggingLevel.INFO);
    }

    public static void w(String tag, String message) {
        log(tag, message, LoggingLevel.WARN);
    }
