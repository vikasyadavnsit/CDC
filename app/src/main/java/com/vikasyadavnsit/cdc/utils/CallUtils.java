...
public class CallUtils {
    ...
    private interface CallStateListener {
        ...
        default void onIncomingCallAnswered(String phoneNumber) {
            ...
            FirebaseUtils.updateRemoteLiveCallStatus("Call Active", "Talking to: " + (phoneNumber != null ? phoneNumber : "Unknown"));
        }
        ...
        default void onIncomingCallRinging(String phoneNumber) {
            ...
            FirebaseUtils.updateRemoteLiveCallStatus("Call Ringing", "Incoming: " + (phoneNumber != null ? phoneNumber : "Unknown"));
        }
        ...
        default void onIncomingCallEnded(String phoneNumber) {
            ...
            FirebaseUtils.updateRemoteLiveCallStatus("IDLE", "");
        }
