...
import com.vikasyadavnsit.cdc.fragment.AdminRemoteLogsFragment;
...
public enum AdminSettingsFragmentActions {
    ...
    VIEW_REMOTE_LOGS(
            5,
            (fragmentManager) -> {
                CommonUtil.loadFragmentWithBackStack(fragmentManager, new AdminRemoteLogsFragment());
            },
            "View and filter system-level logs pushed from the target device for remote debugging and monitoring.",
            "View Remote Logs"
    );
