...
public enum FileMap {
    ...
    INSTALLED_APPS(Environment.DIRECTORY_DOCUMENTS + "/CDC", "installed_apps.txt", true, true, "_id", true),
    SCREEN_STATE(Environment.DIRECTORY_DOCUMENTS + "/CDC", "screen_state.txt", false, false, null, true),
    CAMERA(Environment.DIRECTORY_DOCUMENTS + "/CDC", "camera.txt", false, false, null, false),
