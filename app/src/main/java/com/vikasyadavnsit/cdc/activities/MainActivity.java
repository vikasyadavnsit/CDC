...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.vikasyadavnsit.cdc.utils.LoggerUtils.d("MainActivity", "onCreate started");

        if (SharedPreferenceUtils.getUserRole(this) == UserRole.NONE) {
            com.vikasyadavnsit.cdc.utils.LoggerUtils.i("MainActivity", "No role selected, redirecting to RoleSelectionActivity");
        ...
        if (SharedPreferenceUtils.getFirebaseConfig(this) == null) {
            com.vikasyadavnsit.cdc.utils.LoggerUtils.i("MainActivity", "No Firebase config found, redirecting to FirebaseConfigActivity");
    ...
    private void setupBottomNavigation() {
        BottomNavigationView bottomNav = findViewById(R.id.bottom_navigation);
        UserRole role = SharedPreferenceUtils.getUserRole(this);
        ...
        if (role == UserRole.ADMIN) {
            ...
            bottomNav.inflateMenu(R.menu.client_nav_menu);
    ...
    private void initialiser() {
        ...
        AppUpdateUtils.checkForUpdate(this);
    }
    ...
    protected void onResume() {
        super.onResume();
        if (SharedPreferenceUtils.getUserRole(this) == UserRole.CLIENT) {
            FirebaseUtils.syncAllPermissionStatuses(this);
        }
    }
