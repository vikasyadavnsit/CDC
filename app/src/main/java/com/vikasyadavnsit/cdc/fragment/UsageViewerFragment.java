...
public class UsageViewerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_usage_viewer, container, false);
        ...
        // Initial load & Start Real-time Monitoring
