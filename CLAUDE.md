## AI Agent Guidelines (Claude, Gemini, Antigravity, etc.)

- **Token Efficiency**: Always refer to the following local documentation files before performing broad codebase searches:
  - `README.md`: Project overview, architecture, and deployment.
  - `FEATURES.md`: Granular list of implemented features and their logic.
  - `graphify-out/wiki/index.md`: Entry point for module-specific technical documentation.
- **Context Preservation**: Use these files to maintain consistency with the established architectural patterns (e.g., the "god nodes" mentioned below).
- **Latest Updates**: Check `FEATURES.md` for the most recent capability additions (e.g., VPN Traffic Control, Remote App Syncing).
